...
const pluginUrl='https://borismoniac.github.io/360.info/';
...
<head>
  ...
  <title>НашеПО · Поиск для Топоматик 360</title>
  <style>
...
<body><main>
  <small>Версия ${pkg.version}</small>
  <h1>НашеПО · Поиск</h1>
  <p>Поиск по всему проекту сразу. Введите любое значение, и плагин найдёт элементы во всех моделях проекта и вложений, подсветит их и переведёт камеру.</p>
  ...
  <div class="buttons"><a class="button" href="${installUrl}">Открыть установку в веб-версии</a><a class="button secondary" href="https://github.com/BorisMoniac/360.info">Исходный код</a></div>
  <ol><li>Откройте в настольном Топоматик 360 раздел <b>Плагины</b>.</li><li>Выберите <b>Установить плагин</b>.</li><li>Скопируйте адрес выше, вставьте его в поле и подтвердите установку.</li><li>После первой установки перезапустите приложение. В веб-версии обновите страницу Топоматик 360.</li><li>Откройте слева панель <b>НашеПО</b> и вкладку <b>Поиск</b>, либо нажмите <b>Поиск</b> на ленте.</li></ol>
